classdef Drone < handle %% is used to generate a drone or a swarm of drones... fun:)
%% MEMBERS
    properties
        g 
        t
 ...
 %% METHODS
    ...
    methods
        ...
        function state = GetState(obj)
            state = obj.x; %related to encapsulation... a function to get the state of the drone
        end

        function obj = EvalEOM(obj) % this updates dx
